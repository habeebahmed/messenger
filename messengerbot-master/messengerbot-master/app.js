...
const APP_SECRET = "2384f7c9e9c41a9d19d0c63fe6a576d6"
//(process.env.MESSENGER_APP_SECRET) ?
  //process.env.MESSENGER_APP_SECRET :
//  config.get('appSecret');

// Arbitrary value used to validate a webhook
const VALIDATION_TOKEN = "password";
// (process.env.MESSENGER_VALIDATION_TOKEN) ?
//  (process.env.MESSENGER_VALIDATION_TOKEN) :
//  config.get('validationToken');

// Generate a page access token for your page from the App Dashboard
const PAGE_ACCESS_TOKEN = "EAAElgNzc6VwBAGWyZBydcP5UZCOmvZAZA3U5BEzZBCLnrIlh4n9XUgxznZAhShkDZC8K7wzFazqqp6y26TeXdV9RG9zCSSJsuAXiEaVvWH7Dt14IqqDndRMY3dEOfGg90QjoajmEWfvd3KmPt2bZAmURAN3QGShrMwiokUc4IkImokOq4zEPrVGd";
...
const SERVER_URL = "https://mycruelbot.localtunnel.me"
